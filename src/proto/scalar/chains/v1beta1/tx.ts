...
export interface SignBtcCommandsRequest {
  sender: Uint8Array;
  chain: string;
}
...
export const ConfirmSourceTxsRequest = {
  encode(
  ...
  decode(
    ...
    const message = createBaseConfirmSourceTxsRequest();
  ...
  fromJSON(object: any): ConfirmSourceTxsRequest {
    return {
  ...
  toJSON(message: ConfirmSourceTxsRequest): unknown {
    const obj: any = {};
    if (message.sender.length !== 0) {
  ...
  create<I extends Exact<DeepPartial<ConfirmSourceTxsRequest>, I>>(
    base?: I,
  ): ConfirmSourceTxsRequest {
    return ConfirmSourceTxsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ConfirmSourceTxsRequest>, I>>(
    object: I,
  ): ConfirmSourceTxsRequest {
    const message = createBaseConfirmSourceTxsRequest();
...
function createBaseConfirmSourceTxsResponse(): ConfirmSourceTxsResponse {
  return {};
}

export const ConfirmSourceTxsResponse = {
  encode(
    _: ConfirmSourceTxsResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  decode(
    ...
    const reader =
      input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseConfirmSourceTxsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): ConfirmSourceTxsResponse {
    return {};
  },

  toJSON(_: ConfirmSourceTxsResponse): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<ConfirmSourceTxsResponse>, I>>(
    base?: I,
  ): ConfirmSourceTxsResponse {
    return ConfirmSourceTxsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ConfirmSourceTxsResponse>, I>>(
    _: I,
  ): ConfirmSourceTxsResponse {
    const message = createBaseConfirmSourceTxsResponse();
    return message;
...
function createBaseSignBtcCommandsRequest(): SignBtcCommandsRequest {
  return { sender: new Uint8Array(0), chain: "" };
}

export const SignBtcCommandsRequest = {
  encode(
  ...
  decode(
    ...
    const reader =
      input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSignBtcCommandsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): SignBtcCommandsRequest {
    return {
      sender: isSet(object.sender)
        ? bytesFromBase64(object.sender)
        : new Uint8Array(0),
  ...
  toJSON(message: SignBtcCommandsRequest): unknown {
    const obj: any = {};
    if (message.sender.length !== 0) {
      obj.sender = base64FromBytes(message.sender);
    }
  ...
  create<I extends Exact<DeepPartial<SignBtcCommandsRequest>, I>>(
    base?: I,
  ): SignBtcCommandsRequest {
    return SignBtcCommandsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SignBtcCommandsRequest>, I>>(
    object: I,
  ): SignBtcCommandsRequest {
    const message = createBaseSignBtcCommandsRequest();
    message.sender = object.sender ?? new Uint8Array(0);
