...
export interface MsgService {
  ...
  ): Promise<ConfirmSourceTxsResponse>;
...
export class MsgServiceClientImpl implements MsgService {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.rpc = rpc;
    this.ConfirmSourceTxs = this.ConfirmSourceTxs.bind(this);
  ...
  ConfirmSourceTxs(
    ...
    const data = ConfirmSourceTxsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ConfirmSourceTxs", data);
    return promise.then((data) =>
      ConfirmSourceTxsResponse.decode(_m0.Reader.create(data)),
    );
  }
  ...
  SignBtcCommand(
    ...
    const data = SignBtcCommandsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "SignBtcCommand", data);
    return promise.then((data) =>
      SignCommandsResponse.decode(_m0.Reader.create(data)),
    );
  }
