...
export const protobufPackage = "scalar.vote.v1beta1";
...
export const MsgServiceServiceName = "scalar.vote.v1beta1.MsgService";
...
export const QueryServiceServiceName = "scalar.vote.v1beta1.QueryService";
