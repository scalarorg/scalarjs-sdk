...
export const protobufPackage = "scalar.scalarnet.v1beta1";
...
function createBaseScalarTransferCompleted(): ScalarTransferCompleted {
  return { id: Long.UZERO, receipient: "", asset: undefined, recipient: "" };
}

export const ScalarTransferCompleted = {
  encode(
    message: ScalarTransferCompleted,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (!message.id.equals(Long.UZERO)) {
      writer.uint32(8).uint64(message.id);
  ...
  decode(
    ...
    const reader =
      input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseScalarTransferCompleted();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ScalarTransferCompleted {
    return {
      id: isSet(object.id) ? Long.fromValue(object.id) : Long.UZERO,
      receipient: isSet(object.receipient)
        ? globalThis.String(object.receipient)
  ...
  toJSON(message: ScalarTransferCompleted): unknown {
    const obj: any = {};
    if (!message.id.equals(Long.UZERO)) {
      obj.id = (message.id || Long.UZERO).toString();
    }
  ...
  create<I extends Exact<DeepPartial<ScalarTransferCompleted>, I>>(
    base?: I,
  ): ScalarTransferCompleted {
    return ScalarTransferCompleted.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ScalarTransferCompleted>, I>>(
    object: I,
  ): ScalarTransferCompleted {
    const message = createBaseScalarTransferCompleted();
    message.id =
