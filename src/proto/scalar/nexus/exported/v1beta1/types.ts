...
export const protobufPackage = "scalar.nexus.exported.v1beta1";
...
export const Chain = {
  encode(message: Chain, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.supportsForeignAssets !== false) {
      writer.uint32(16).bool(message.supportsForeignAssets);
    }
...
export const CrossChainTransfer = {
  encode(
    ...
    if (message.sourceTxHash.length !== 0) {
      writer.uint32(42).bytes(message.sourceTxHash);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          message.sourceTxHash = reader.bytes();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): CrossChainTransfer {
    return {
      ...
      sourceTxHash: isSet(object.sourceTxHash)
        ? bytesFromBase64(object.sourceTxHash)
        : new Uint8Array(0),
    };
  },
  ...
  toJSON(message: CrossChainTransfer): unknown {
    ...
    if (message.sourceTxHash.length !== 0) {
      obj.sourceTxHash = base64FromBytes(message.sourceTxHash);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CrossChainTransfer>, I>>(
    ...
    message.sourceTxHash = object.sourceTxHash ?? new Uint8Array(0);
    return message;
  },
};
