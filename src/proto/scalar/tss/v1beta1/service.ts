...
export const protobufPackage = "scalar.tss.v1beta1";
...
export const MsgServiceServiceName = "scalar.tss.v1beta1.MsgService";
...
export const QueryServiceServiceName = "scalar.tss.v1beta1.QueryService";
