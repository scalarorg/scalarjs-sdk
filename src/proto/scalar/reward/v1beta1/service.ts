...
export const protobufPackage = "scalar.reward.v1beta1";
...
export const MsgServiceServiceName = "scalar.reward.v1beta1.MsgService";
...
export const QueryServiceServiceName = "scalar.reward.v1beta1.QueryService";
