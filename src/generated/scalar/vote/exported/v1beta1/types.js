...
class PollMetadata$Type extends MessageType {
    constructor() {
        super("scalar.vote.exported.v1beta1.PollMetadata", [
            ...
            { no: 6, name: "state", kind: "enum", T: () => ["scalar.vote.exported.v1beta1.PollState", PollState, "POLL_STATE_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.protobuf.Any result */ 4:
                    ...
                    break;
                case /* scalar.utils.v1beta1.Threshold voting_threshold */ 5:
                    message.votingThreshold = Threshold.internalBinaryRead(reader, reader.uint32(), options, message.votingThreshold);
                    break;
                case /* scalar.vote.exported.v1beta1.PollState state */ 6:
                ...
                case /* uint64 id */ 13:
                    ...
                    break;
                case /* scalar.snapshot.exported.v1beta1.Snapshot snapshot */ 15:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* scalar.vote.exported.v1beta1.PollState state = 6; */
        if (message.state !== 0)
...
class PollKey$Type extends MessageType {
    constructor() {
        super("scalar.vote.exported.v1beta1.PollKey", [
...
class PollParticipants$Type extends MessageType {
    constructor() {
        super("scalar.vote.exported.v1beta1.PollParticipants", [
