...
// @generated from protobuf file "scalar/evm/v1beta1/types.proto" (package "scalar.evm.v1beta1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf enum scalar.evm.v1beta1.Event.Status
 */
...
/**
 * @generated from protobuf enum scalar.evm.v1beta1.Status
 */
export var Status;
(function (Status) {
    /**
...
/**
 * @generated from protobuf enum scalar.evm.v1beta1.CommandType
 */
...
/**
 * @generated from protobuf enum scalar.evm.v1beta1.BatchedCommandsStatus
 */
...
/**
 * @generated from protobuf enum scalar.evm.v1beta1.SigType
 */
export var SigType;
(function (SigType) {
    /**
...
/**
 * @generated from protobuf enum scalar.evm.v1beta1.DepositStatus
 */
...
class VoteEvents$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.VoteEvents", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string chain */ 1:
                    ...
                    break;
                case /* repeated scalar.evm.v1beta1.Event events */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* repeated scalar.evm.v1beta1.Event events = 2; */
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.VoteEvents
 */
export const VoteEvents = new VoteEvents$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Event$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.Event", [
            { no: 1, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
            ...
            { no: 4, name: "status", kind: "enum", T: () => ["scalar.evm.v1beta1.Event.Status", Event_Status, "STATUS_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 index */ 3:
                    ...
                    break;
                case /* scalar.evm.v1beta1.Event.Status status */ 4:
                    message.status = reader.int32();
                    break;
                case /* scalar.evm.v1beta1.EventTokenSent token_sent */ 5:
                    message.event = {
                        oneofKind: "tokenSent",
                        tokenSent: EventTokenSent.internalBinaryRead(reader, reader.uint32(), options, message.event.tokenSent)
                    };
                    break;
                case /* scalar.evm.v1beta1.EventContractCall contract_call */ 6:
                    message.event = {
                    ...
                    break;
                case /* scalar.evm.v1beta1.EventContractCallWithToken contract_call_with_token */ 7:
                    message.event = {
                    ...
                    break;
                case /* scalar.evm.v1beta1.EventTransfer transfer */ 8:
                    message.event = {
                        oneofKind: "transfer",
                        transfer: EventTransfer.internalBinaryRead(reader, reader.uint32(), options, message.event.transfer)
                    };
                    break;
                case /* scalar.evm.v1beta1.EventTokenDeployed token_deployed */ 9:
                    message.event = {
                    ...
                    break;
                case /* scalar.evm.v1beta1.EventMultisigOwnershipTransferred multisig_ownership_transferred = 10 [deprecated = true];*/ 10:
                    message.event = {
                    ...
                    break;
                case /* scalar.evm.v1beta1.EventMultisigOperatorshipTransferred multisig_operatorship_transferred */ 11:
                    message.event = {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* scalar.evm.v1beta1.Event.Status status = 4; */
        if (message.status !== 0)
            writer.tag(4, WireType.Varint).int32(message.status);
        /* scalar.evm.v1beta1.EventTokenSent token_sent = 5; */
        ...
        /* scalar.evm.v1beta1.EventContractCall contract_call = 6; */
        ...
        /* scalar.evm.v1beta1.EventContractCallWithToken contract_call_with_token = 7; */
        ...
        /* scalar.evm.v1beta1.EventTransfer transfer = 8; */
        ...
        /* scalar.evm.v1beta1.EventTokenDeployed token_deployed = 9; */
        ...
        /* scalar.evm.v1beta1.EventMultisigOwnershipTransferred multisig_ownership_transferred = 10 [deprecated = true]; */
        ...
        /* scalar.evm.v1beta1.EventMultisigOperatorshipTransferred multisig_operatorship_transferred = 11; */
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.Event
 */
export const Event = new Event$Type();
// @generated message type with reflection information, may provide speed optimized methods
class EventTokenSent$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.EventTokenSent", [
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.EventTokenSent
 */
export const EventTokenSent = new EventTokenSent$Type();
// @generated message type with reflection information, may provide speed optimized methods
class EventContractCall$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.EventContractCall", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "Address" } },
            { no: 2, name: "destination_chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.EventContractCall
 */
export const EventContractCall = new EventContractCall$Type();
// @generated message type with reflection information, may provide speed optimized methods
class EventContractCallWithToken$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.EventContractCallWithToken", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "Address" } },
            { no: 2, name: "destination_chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
            { no: 3, name: "contract_address", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "payload_hash", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "Hash" } },
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.EventContractCallWithToken
 */
export const EventContractCallWithToken = new EventContractCallWithToken$Type();
// @generated message type with reflection information, may provide speed optimized methods
class EventTransfer$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.EventTransfer", [
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.EventTransfer
 */
export const EventTransfer = new EventTransfer$Type();
// @generated message type with reflection information, may provide speed optimized methods
class EventTokenDeployed$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.EventTokenDeployed", [
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.EventTokenDeployed
 */
...
class EventMultisigOwnershipTransferred$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.EventMultisigOwnershipTransferred", [
...
/**
 * @deprecated
 * @generated MessageType for protobuf message scalar.evm.v1beta1.EventMultisigOwnershipTransferred
 */
...
class EventMultisigOperatorshipTransferred$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.EventMultisigOperatorshipTransferred", [
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.EventMultisigOperatorshipTransferred
 */
...
class NetworkInfo$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.NetworkInfo", [
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.NetworkInfo
 */
export const NetworkInfo = new NetworkInfo$Type();
// @generated message type with reflection information, may provide speed optimized methods
class BurnerInfo$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.BurnerInfo", [
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.BurnerInfo
 */
export const BurnerInfo = new BurnerInfo$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ERC20Deposit$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.ERC20Deposit", [
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.ERC20Deposit
 */
export const ERC20Deposit = new ERC20Deposit$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ERC20TokenMetadata$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.ERC20TokenMetadata", [
            ...
            { no: 7, name: "status", kind: "enum", T: () => ["scalar.evm.v1beta1.Status", Status, "STATUS_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bytes chain_id */ 2:
                    ...
                    break;
                case /* scalar.evm.v1beta1.TokenDetails details */ 3:
                ...
                case /* string tx_hash */ 5:
                    ...
                    break;
                case /* scalar.evm.v1beta1.Status status */ 7:
                    message.status = reader.int32();
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* scalar.evm.v1beta1.TokenDetails details = 3; */
        if (message.details)
        ...
        /* scalar.evm.v1beta1.Status status = 7; */
        if (message.status !== 0)
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.ERC20TokenMetadata
 */
export const ERC20TokenMetadata = new ERC20TokenMetadata$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TransactionMetadata$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.TransactionMetadata", [
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.TransactionMetadata
 */
export const TransactionMetadata = new TransactionMetadata$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Command$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.Command", [
            ...
            { no: 6, name: "type", kind: "enum", T: () => ["scalar.evm.v1beta1.CommandType", CommandType, "COMMAND_TYPE_"] }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint32 max_gas_cost */ 5:
                    ...
                    break;
                case /* scalar.evm.v1beta1.CommandType type */ 6:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* scalar.evm.v1beta1.CommandType type = 6; */
        if (message.type !== 0)
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.Command
 */
export const Command = new Command$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CommandBatchMetadata$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.CommandBatchMetadata", [
            ...
            { no: 5, name: "status", kind: "enum", T: () => ["scalar.evm.v1beta1.BatchedCommandsStatus", BatchedCommandsStatus, "BATCHED_COMMANDS_STATUS_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bytes sig_hash */ 4:
                    ...
                    break;
                case /* scalar.evm.v1beta1.BatchedCommandsStatus status */ 5:
                    message.status = reader.int32();
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* scalar.evm.v1beta1.BatchedCommandsStatus status = 5; */
        if (message.status !== 0)
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.CommandBatchMetadata
 */
export const CommandBatchMetadata = new CommandBatchMetadata$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SigMetadata$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.SigMetadata", [
            { no: 1, name: "type", kind: "enum", T: () => ["scalar.evm.v1beta1.SigType", SigType, "SIG_TYPE_"] },
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* scalar.evm.v1beta1.SigType type */ 1:
                    message.type = reader.int32();
                    break;
                case /* string chain */ 2:
                    message.chain = reader.string();
    ...
    internalBinaryWrite(message, writer, options) {
        /* scalar.evm.v1beta1.SigType type = 1; */
        if (message.type !== 0)
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.SigMetadata
 */
export const SigMetadata = new SigMetadata$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TransferKey$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.TransferKey", [
            { no: 1, name: "tx_id", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "Hash", "gogoproto.customname": "TxID" } },
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.TransferKey
 */
export const TransferKey = new TransferKey$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Asset$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.Asset", [
            { no: 1, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.Asset
 */
export const Asset = new Asset$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TokenDetails$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.TokenDetails", [
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.TokenDetails
 */
export const TokenDetails = new TokenDetails$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Gateway$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.Gateway", [
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.Gateway
 */
export const Gateway = new Gateway$Type();
// @generated message type with reflection information, may provide speed optimized methods
class PollMetadata$Type extends MessageType {
    constructor() {
        super("scalar.evm.v1beta1.PollMetadata", [
            { no: 1, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
            { no: 2, name: "tx_id", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "Hash", "gogoproto.customname": "TxID" } }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message scalar.evm.v1beta1.PollMetadata
 */
