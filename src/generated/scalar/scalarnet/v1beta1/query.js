...
class PendingIBCTransferCountRequest$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.PendingIBCTransferCountRequest", []);
    }
    create(value) {
...
class PendingIBCTransferCountResponse$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.PendingIBCTransferCountResponse", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.uint32();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field scalar.scalarnet.v1beta1.PendingIBCTransferCountResponse.transfers_by_chain");
            }
        }
...
class ParamsRequest$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.ParamsRequest", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class ParamsResponse$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.ParamsResponse", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* scalar.scalarnet.v1beta1.Params params */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        /* scalar.scalarnet.v1beta1.Params params = 1; */
        if (message.params)
...
class IBCPathRequest$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.IBCPathRequest", [
...
class IBCPathResponse$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.IBCPathResponse", [
...
class ChainByIBCPathRequest$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.ChainByIBCPathRequest", [
...
class ChainByIBCPathResponse$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.ChainByIBCPathResponse", [
