...
class LinkRequest$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.LinkRequest", [
            ...
            { no: 3, name: "recipient_chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
...
class LinkResponse$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.LinkResponse", [
...
class ConfirmDepositRequest$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.ConfirmDepositRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
...
class ConfirmDepositResponse$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.ConfirmDepositResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class ExecutePendingTransfersRequest$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.ExecutePendingTransfersRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } }
        ], { "scalar.permission.exported.v1beta1.permission_role": "ROLE_UNRESTRICTED" });
    }
    create(value) {
...
class ExecutePendingTransfersResponse$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.ExecutePendingTransfersResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class RegisterIBCPathRequest$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.RegisterIBCPathRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
...
class RegisterIBCPathResponse$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.RegisterIBCPathResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class AddCosmosBasedChainRequest$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.AddCosmosBasedChainRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
            ...
            { no: 6, name: "cosmos_chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bytes sender */ 1:
                    message.sender = reader.bytes();
                    break;
                case /* scalar.nexus.exported.v1beta1.Chain chain = 2 [deprecated = true];*/ 2:
                ...
                case /* string addr_prefix */ 3:
                    ...
                    break;
                case /* repeated scalar.nexus.exported.v1beta1.Asset native_assets = 5 [deprecated = true];*/ 5:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.sender.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.sender);
        /* scalar.nexus.exported.v1beta1.Chain chain = 2 [deprecated = true]; */
        if (message.chain)
        ...
        /* repeated scalar.nexus.exported.v1beta1.Asset native_assets = 5 [deprecated = true]; */
...
class AddCosmosBasedChainResponse$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.AddCosmosBasedChainResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class RegisterAssetRequest$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.RegisterAssetRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
            { no: 2, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string chain */ 2:
                    message.chain = reader.string();
                    break;
                case /* scalar.nexus.exported.v1beta1.Asset asset */ 3:
...
class RegisterAssetResponse$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.RegisterAssetResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class RouteIBCTransfersRequest$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.RouteIBCTransfersRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } }
        ], { "scalar.permission.exported.v1beta1.permission_role": "ROLE_UNRESTRICTED" });
    }
    create(value) {
...
class RouteIBCTransfersResponse$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.RouteIBCTransfersResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class RegisterFeeCollectorRequest$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.RegisterFeeCollectorRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
...
class RegisterFeeCollectorResponse$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.RegisterFeeCollectorResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class RetryIBCTransferRequest$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.RetryIBCTransferRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
            { no: 2, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
            { no: 3, name: "id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, options: { "gogoproto.customname": "ID", "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.TransferID" } }
        ], { "scalar.permission.exported.v1beta1.permission_role": "ROLE_UNRESTRICTED" });
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
...
class RetryIBCTransferResponse$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.RetryIBCTransferResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class RouteMessageRequest$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.RouteMessageRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
...
class RouteMessageResponse$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.RouteMessageResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class CallContractRequest$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.CallContractRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
            { no: 2, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bytes payload */ 4:
                    message.payload = reader.bytes();
                    break;
                case /* scalar.scalarnet.v1beta1.Fee fee */ 5:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* scalar.scalarnet.v1beta1.Fee fee = 5; */
        if (message.fee)
...
class CallContractResponse$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.CallContractResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
