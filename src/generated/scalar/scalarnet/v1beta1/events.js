...
class IBCTransferSent$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.IBCTransferSent", [
            { no: 1, name: "id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, options: { "gogoproto.customname": "ID", "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.TransferID" } },
...
class IBCTransferCompleted$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.IBCTransferCompleted", [
            { no: 1, name: "id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, options: { "gogoproto.customname": "ID", "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.TransferID" } },
...
class IBCTransferFailed$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.IBCTransferFailed", [
            { no: 1, name: "id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, options: { "gogoproto.customname": "ID", "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.TransferID" } },
            { no: 2, name: "sequence", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 3, name: "port_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "PortID" } },
            { no: 4, name: "channel_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "ChannelID" } }
...
class IBCTransferRetried$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.IBCTransferRetried", [
            { no: 1, name: "id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, options: { "gogoproto.customname": "ID", "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.TransferID" } },
            { no: 2, name: "receipient", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "asset", kind: "message", T: () => Coin, options: { "gogoproto.nullable": false } },
            { no: 4, name: "sequence", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
...
// @generated message type with reflection information, may provide speed optimized methods
class ScalarTransferCompleted$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.ScalarTransferCompleted", [
            { no: 1, name: "id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, options: { "gogoproto.customname": "ID", "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.TransferID" } },
            { no: 2, name: "receipient", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "asset", kind: "message", T: () => Coin, options: { "gogoproto.nullable": false } },
 ...
 */
export const ScalarTransferCompleted = new ScalarTransferCompleted$Type();
// @generated message type with reflection information, may provide speed optimized methods
class FeeCollected$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.FeeCollected", [
...
class FeePaid$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.FeePaid", [
            ...
            { no: 6, name: "source_chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
            { no: 7, name: "destination_chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string asset */ 5:
                    ...
                    break;
                case /* string source_chain */ 6:
                    message.sourceChain = reader.string();
                    break;
                case /* string destination_chain */ 7:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.sourceChain !== "")
            writer.tag(6, WireType.LengthDelimited).string(message.sourceChain);
        /* string destination_chain = 7; */
        if (message.destinationChain !== "")
            writer.tag(7, WireType.LengthDelimited).string(message.destinationChain);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class ContractCallSubmitted$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.ContractCallSubmitted", [
            { no: 1, name: "message_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "MessageID" } },
            { no: 2, name: "sender", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "source_chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
...
class ContractCallWithTokenSubmitted$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.ContractCallWithTokenSubmitted", [
            { no: 1, name: "message_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "MessageID" } },
            { no: 2, name: "sender", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "source_chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
            { no: 4, name: "destination_chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
...
class TokenSent$Type extends MessageType {
    constructor() {
        super("scalar.scalarnet.v1beta1.TokenSent", [
