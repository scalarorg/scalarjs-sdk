...
// @generated from protobuf file "scalar/nexus/v1beta1/events.proto" (package "scalar.nexus.v1beta1", syntax proto3)
// tslint:disable
...
class FeeDeducted$Type extends MessageType {
    constructor() {
        super("scalar.nexus.v1beta1.FeeDeducted", [
            { no: 1, name: "transfer_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, options: { "gogoproto.customname": "TransferID", "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.TransferID" } },
            { no: 2, name: "recipient_chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
...
/**
 * @generated MessageType for protobuf message scalar.nexus.v1beta1.FeeDeducted
 */
export const FeeDeducted = new FeeDeducted$Type();
// @generated message type with reflection information, may provide speed optimized methods
class InsufficientFee$Type extends MessageType {
    constructor() {
        super("scalar.nexus.v1beta1.InsufficientFee", [
            { no: 1, name: "transfer_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, options: { "gogoproto.customname": "TransferID", "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.TransferID" } },
            { no: 2, name: "recipient_chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
            { no: 3, name: "recipient_address", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "amount", kind: "message", T: () => Coin, options: { "gogoproto.nullable": false } },
...
/**
 * @generated MessageType for protobuf message scalar.nexus.v1beta1.InsufficientFee
 */
export const InsufficientFee = new InsufficientFee$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RateLimitUpdated$Type extends MessageType {
    constructor() {
        super("scalar.nexus.v1beta1.RateLimitUpdated", [
...
/**
 * @generated MessageType for protobuf message scalar.nexus.v1beta1.RateLimitUpdated
 */
export const RateLimitUpdated = new RateLimitUpdated$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MessageReceived$Type extends MessageType {
    constructor() {
        super("scalar.nexus.v1beta1.MessageReceived", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bytes payload_hash */ 2:
                    ...
                    break;
                case /* scalar.nexus.exported.v1beta1.CrossChainAddress sender */ 3:
                    message.sender = CrossChainAddress.internalBinaryRead(reader, reader.uint32(), options, message.sender);
                    break;
                case /* scalar.nexus.exported.v1beta1.CrossChainAddress recipient */ 4:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* scalar.nexus.exported.v1beta1.CrossChainAddress sender = 3; */
        if (message.sender)
            CrossChainAddress.internalBinaryWrite(message.sender, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* scalar.nexus.exported.v1beta1.CrossChainAddress recipient = 4; */
...
/**
 * @generated MessageType for protobuf message scalar.nexus.v1beta1.MessageReceived
 */
export const MessageReceived = new MessageReceived$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MessageProcessing$Type extends MessageType {
    constructor() {
        super("scalar.nexus.v1beta1.MessageProcessing", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "ID" } },
            { no: 2, name: "source_chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.sourceChain !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.sourceChain);
...
/**
 * @generated MessageType for protobuf message scalar.nexus.v1beta1.MessageProcessing
 */
export const MessageProcessing = new MessageProcessing$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MessageExecuted$Type extends MessageType {
    constructor() {
        super("scalar.nexus.v1beta1.MessageExecuted", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "ID" } },
            { no: 2, name: "source_chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
            { no: 3, name: "destination_chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } }
        ]);
...
/**
 * @generated MessageType for protobuf message scalar.nexus.v1beta1.MessageExecuted
 */
export const MessageExecuted = new MessageExecuted$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MessageFailed$Type extends MessageType {
    constructor() {
        super("scalar.nexus.v1beta1.MessageFailed", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "ID" } },
            { no: 2, name: "source_chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } },
            { no: 3, name: "destination_chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/scalarorg/scalar-core/x/nexus/exported.ChainName" } }
        ]);
...
/**
 * @generated MessageType for protobuf message scalar.nexus.v1beta1.MessageFailed
 */
export const MessageFailed = new MessageFailed$Type();
// @generated message type with reflection information, may provide speed optimized methods
class WasmMessageRouted$Type extends MessageType {
    constructor() {
        super("scalar.nexus.v1beta1.WasmMessageRouted", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* scalar.nexus.exported.v1beta1.WasmMessage message */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        /* scalar.nexus.exported.v1beta1.WasmMessage message = 1; */
        if (message.message)
...
/**
 * @generated MessageType for protobuf message scalar.nexus.v1beta1.WasmMessageRouted
 */
