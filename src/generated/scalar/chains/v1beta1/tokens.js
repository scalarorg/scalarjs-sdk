...
class ERC20TokenMetadata$Type extends MessageType {
    constructor() {
        super("scalar.chains.v1beta1.ERC20TokenMetadata", [
            ...
            { no: 7, name: "status", kind: "enum", T: () => ["scalar.chains.v1beta1.Status", Status, "STATUS_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bytes chain_id */ 2:
                    ...
                    break;
                case /* scalar.chains.v1beta1.TokenDetails details */ 3:
                ...
                case /* string tx_hash */ 5:
                    ...
                    break;
                case /* scalar.chains.v1beta1.Status status */ 7:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* scalar.chains.v1beta1.TokenDetails details = 3; */
        if (message.details)
        ...
        /* scalar.chains.v1beta1.Status status = 7; */
        if (message.status !== 0)
...
class ERC20Deposit$Type extends MessageType {
    constructor() {
        super("scalar.chains.v1beta1.ERC20Deposit", [
