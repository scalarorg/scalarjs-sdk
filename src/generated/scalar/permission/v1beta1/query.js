...
class QueryGovernanceKeyRequest$Type extends MessageType {
    constructor() {
        super("scalar.permission.v1beta1.QueryGovernanceKeyRequest", []);
    }
    create(value) {
...
class QueryGovernanceKeyResponse$Type extends MessageType {
    constructor() {
        super("scalar.permission.v1beta1.QueryGovernanceKeyResponse", [
...
class ParamsRequest$Type extends MessageType {
    constructor() {
        super("scalar.permission.v1beta1.ParamsRequest", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class ParamsResponse$Type extends MessageType {
    constructor() {
        super("scalar.permission.v1beta1.ParamsResponse", [
