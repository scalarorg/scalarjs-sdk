...
class KeyPresenceRequest$Type extends MessageType {
    constructor() {
        super("tofnd.KeyPresenceRequest", [
...
class KeyPresenceResponse$Type extends MessageType {
    constructor() {
        super("tofnd.KeyPresenceResponse", [
            { no: 1, name: "response", kind: "enum", T: () => ["tofnd.KeyPresenceResponse.Response", KeyPresenceResponse_Response, "RESPONSE_"] }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* tofnd.KeyPresenceResponse.Response response */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        /* tofnd.KeyPresenceResponse.Response response = 1; */
