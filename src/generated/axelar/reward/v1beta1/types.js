...
class Pool$Type extends MessageType {
    constructor() {
        super("axelar.reward.v1beta1.Pool", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string name */ 1:
                    ...
                    break;
                case /* repeated axelar.reward.v1beta1.Pool.Reward rewards */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* repeated axelar.reward.v1beta1.Pool.Reward rewards = 2; */
...
class Pool_Reward$Type extends MessageType {
    constructor() {
        super("axelar.reward.v1beta1.Pool.Reward", [
...
class Refund$Type extends MessageType {
    constructor() {
        super("axelar.reward.v1beta1.Refund", [
