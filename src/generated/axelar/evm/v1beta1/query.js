...
class DepositQueryParams$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.DepositQueryParams", [
            { no: 1, name: "address", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "asset", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/nexus/exported.ChainName" } }
        ]);
    }
    create(value) {
...
class BatchedCommandsRequest$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.BatchedCommandsRequest", [
...
class BatchedCommandsResponse$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.BatchedCommandsResponse", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "ID" } },
            { no: 2, name: "data", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "status", kind: "enum", T: () => ["axelar.evm.v1beta1.BatchedCommandsStatus", BatchedCommandsStatus, "BATCHED_COMMANDS_STATUS_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string data */ 2:
                    ...
                    break;
                case /* axelar.evm.v1beta1.BatchedCommandsStatus status */ 3:
                ...
                case /* repeated string command_ids */ 8:
                    ...
                    break;
                case /* axelar.evm.v1beta1.Proof proof */ 9:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* axelar.evm.v1beta1.BatchedCommandsStatus status = 3; */
        if (message.status !== 0)
        ...
        /* axelar.evm.v1beta1.Proof proof = 9; */
        if (message.proof)
...
class KeyAddressRequest$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.KeyAddressRequest", [
            { no: 1, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "key_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "KeyID", "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/multisig/exported.KeyID" } }
        ]);
    }
...
class KeyAddressResponse$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.KeyAddressResponse", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string key_id */ 1:
                    message.keyId = reader.string();
                    break;
                case /* repeated axelar.evm.v1beta1.KeyAddressResponse.WeightedAddress addresses */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* repeated axelar.evm.v1beta1.KeyAddressResponse.WeightedAddress addresses = 2; */
...
class KeyAddressResponse_WeightedAddress$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.KeyAddressResponse.WeightedAddress", [
            { no: 1, name: "address", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class QueryTokenAddressResponse$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.QueryTokenAddressResponse", [
            { no: 1, name: "address", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class QueryDepositStateParams$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.QueryDepositStateParams", [
...
class DepositStateRequest$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.DepositStateRequest", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string chain */ 1:
                    message.chain = reader.string();
                    break;
                case /* axelar.evm.v1beta1.QueryDepositStateParams params */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.chain !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.chain);
        /* axelar.evm.v1beta1.QueryDepositStateParams params = 2; */
        if (message.params)
...
class DepositStateResponse$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.DepositStateResponse", [
            { no: 2, name: "status", kind: "enum", T: () => ["axelar.evm.v1beta1.DepositStatus", DepositStatus, "DEPOSIT_STATUS_"] }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* axelar.evm.v1beta1.DepositStatus status */ 2:
                    message.status = reader.int32();
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message, writer, options) {
        /* axelar.evm.v1beta1.DepositStatus status = 2; */
        if (message.status !== 0)
...
class EventRequest$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.EventRequest", [
            { no: 1, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class EventResponse$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.EventResponse", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* axelar.evm.v1beta1.Event event */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        /* axelar.evm.v1beta1.Event event = 1; */
        if (message.event)
...
class QueryBurnerAddressResponse$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.QueryBurnerAddressResponse", [
            { no: 1, name: "address", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value) {
...
class ChainsRequest$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.ChainsRequest", [
            { no: 1, name: "status", kind: "enum", T: () => ["axelar.evm.v1beta1.ChainStatus", ChainStatus, "CHAIN_STATUS_"] }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* axelar.evm.v1beta1.ChainStatus status */ 1:
                    message.status = reader.int32();
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message, writer, options) {
        /* axelar.evm.v1beta1.ChainStatus status = 1; */
        if (message.status !== 0)
...
class ChainsResponse$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.ChainsResponse", [
...
class CommandRequest$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.CommandRequest", [
            { no: 1, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class CommandResponse$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.CommandResponse", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "ID" } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field axelar.evm.v1beta1.CommandResponse.params");
            }
        }
...
class PendingCommandsRequest$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.PendingCommandsRequest", [
            { no: 1, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value) {
...
class PendingCommandsResponse$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.PendingCommandsResponse", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated axelar.evm.v1beta1.QueryCommandResponse commands */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        /* repeated axelar.evm.v1beta1.QueryCommandResponse commands = 1; */
...
class QueryCommandResponse$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.QueryCommandResponse", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "ID" } },
            { no: 2, name: "type", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "params", kind: "map", K: 9 /*ScalarType.STRING*/, V: { kind: "scalar", T: 9 /*ScalarType.STRING*/ }, options: { "gogoproto.nullable": false } },
            { no: 4, name: "key_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "KeyID" } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field axelar.evm.v1beta1.QueryCommandResponse.params");
            }
        }
        map[key !== null && key !== void 0 ? key : ""] = val !== null && val !== void 0 ? val : "";
    }
...
class BurnerInfoRequest$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.BurnerInfoRequest", [
...
class BurnerInfoResponse$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.BurnerInfoResponse", [
            { no: 1, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/nexus/exported.ChainName" } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string chain */ 1:
                    message.chain = reader.string();
                    break;
                case /* axelar.evm.v1beta1.BurnerInfo burner_info */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.chain !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.chain);
        /* axelar.evm.v1beta1.BurnerInfo burner_info = 2; */
...
class ConfirmationHeightRequest$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.ConfirmationHeightRequest", [
            { no: 1, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value) {
...
class ConfirmationHeightResponse$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.ConfirmationHeightResponse", [
...
class GatewayAddressRequest$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.GatewayAddressRequest", [
            { no: 1, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value) {
...
class GatewayAddressResponse$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.GatewayAddressResponse", [
            { no: 1, name: "address", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value) {
...
class BytecodeRequest$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.BytecodeRequest", [
            { no: 1, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class BytecodeResponse$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.BytecodeResponse", [
...
class ERC20TokensRequest$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.ERC20TokensRequest", [
            { no: 1, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "type", kind: "enum", T: () => ["axelar.evm.v1beta1.TokenType", TokenType, "TOKEN_TYPE_"] }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string chain */ 1:
                    message.chain = reader.string();
                    break;
                case /* axelar.evm.v1beta1.TokenType type */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.chain !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.chain);
        /* axelar.evm.v1beta1.TokenType type = 2; */
        if (message.type !== 0)
...
class ERC20TokensResponse$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.ERC20TokensResponse", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated axelar.evm.v1beta1.ERC20TokensResponse.Token tokens */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        /* repeated axelar.evm.v1beta1.ERC20TokensResponse.Token tokens = 1; */
...
class ERC20TokensResponse_Token$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.ERC20TokensResponse.Token", [
...
class TokenInfoRequest$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.TokenInfoRequest", [
            { no: 1, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class TokenInfoResponse$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.TokenInfoResponse", [
            { no: 1, name: "asset", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string asset */ 1:
                    message.asset = reader.string();
                    break;
                case /* axelar.evm.v1beta1.TokenDetails details */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.asset !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.asset);
        /* axelar.evm.v1beta1.TokenDetails details = 2; */
        if (message.details)
...
class Proof$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.Proof", [
...
class ParamsRequest$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.ParamsRequest", [
            { no: 1, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value) {
...
class ParamsResponse$Type extends MessageType {
    constructor() {
        super("axelar.evm.v1beta1.ParamsResponse", [
