...
class TalliedVote$Type extends MessageType {
    constructor() {
        super("axelar.vote.v1beta1.TalliedVote", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.bool();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field axelar.vote.v1beta1.TalliedVote.is_voter_late");
            }
        }
