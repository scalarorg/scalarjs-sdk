...
class GenesisState$Type extends MessageType {
    constructor() {
        super("axelar.permission.v1beta1.GenesisState", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* cosmos.crypto.multisig.LegacyAminoPubKey governance_key */ 2:
                    ...
                    break;
                case /* repeated axelar.permission.v1beta1.GovAccount gov_accounts */ 3:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* repeated axelar.permission.v1beta1.GovAccount gov_accounts = 3; */
