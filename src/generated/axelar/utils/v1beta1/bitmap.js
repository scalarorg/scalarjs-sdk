...
class Bitmap$Type extends MessageType {
    constructor() {
        super("axelar.utils.v1beta1.Bitmap", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* axelar.utils.v1beta1.CircularBuffer true_count_cache */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        /* axelar.utils.v1beta1.CircularBuffer true_count_cache = 2; */
...
class CircularBuffer$Type extends MessageType {
    constructor() {
        super("axelar.utils.v1beta1.CircularBuffer", [
