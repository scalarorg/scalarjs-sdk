...
class QueryValidatorsResponse$Type extends MessageType {
    constructor() {
        super("axelar.snapshot.v1beta1.QueryValidatorsResponse", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated axelar.snapshot.v1beta1.QueryValidatorsResponse.Validator validators */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        /* repeated axelar.snapshot.v1beta1.QueryValidatorsResponse.Validator validators = 1; */
...
class QueryValidatorsResponse_TssIllegibilityInfo$Type extends MessageType {
    constructor() {
        super("axelar.snapshot.v1beta1.QueryValidatorsResponse.TssIllegibilityInfo", [
...
class QueryValidatorsResponse_Validator$Type extends MessageType {
    constructor() {
        super("axelar.snapshot.v1beta1.QueryValidatorsResponse.Validator", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string moniker */ 2:
                    ...
                    break;
                case /* axelar.snapshot.v1beta1.QueryValidatorsResponse.TssIllegibilityInfo tss_illegibility_info */ 3:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* axelar.snapshot.v1beta1.QueryValidatorsResponse.TssIllegibilityInfo tss_illegibility_info = 3; */
...
class ParamsRequest$Type extends MessageType {
    constructor() {
        super("axelar.snapshot.v1beta1.ParamsRequest", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class ParamsResponse$Type extends MessageType {
    constructor() {
        super("axelar.snapshot.v1beta1.ParamsResponse", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* axelar.snapshot.v1beta1.Params params */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        /* axelar.snapshot.v1beta1.Params params = 1; */
        if (message.params)
