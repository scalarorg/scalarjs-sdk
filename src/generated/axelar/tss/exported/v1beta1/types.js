...
class KeyRequirement$Type extends MessageType {
    constructor() {
        super("axelar.tss.exported.v1beta1.KeyRequirement", [
            { no: 1, name: "key_role", kind: "enum", T: () => ["axelar.tss.exported.v1beta1.KeyRole", KeyRole, "KEY_ROLE_"] },
            { no: 2, name: "key_type", kind: "enum", T: () => ["axelar.tss.exported.v1beta1.KeyType", KeyType, "KEY_TYPE_"] },
            ...
            { no: 5, name: "key_share_distribution_policy", kind: "enum", T: () => ["axelar.tss.exported.v1beta1.KeyShareDistributionPolicy", KeyShareDistributionPolicy, "KEY_SHARE_DISTRIBUTION_POLICY_"] },
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* axelar.tss.exported.v1beta1.KeyRole key_role */ 1:
                    message.keyRole = reader.int32();
                    break;
                case /* axelar.tss.exported.v1beta1.KeyType key_type */ 2:
                    message.keyType = reader.int32();
                    break;
                case /* axelar.utils.v1beta1.Threshold min_keygen_threshold */ 3:
                    message.minKeygenThreshold = Threshold.internalBinaryRead(reader, reader.uint32(), options, message.minKeygenThreshold);
                    break;
                case /* axelar.utils.v1beta1.Threshold safety_threshold */ 4:
                    message.safetyThreshold = Threshold.internalBinaryRead(reader, reader.uint32(), options, message.safetyThreshold);
                    break;
                case /* axelar.tss.exported.v1beta1.KeyShareDistributionPolicy key_share_distribution_policy */ 5:
                ...
                case /* int64 min_total_share_count */ 7:
                    ...
                    break;
                case /* axelar.utils.v1beta1.Threshold keygen_voting_threshold */ 8:
                    message.keygenVotingThreshold = Threshold.internalBinaryRead(reader, reader.uint32(), options, message.keygenVotingThreshold);
                    break;
                case /* axelar.utils.v1beta1.Threshold sign_voting_threshold */ 9:
    ...
    internalBinaryWrite(message, writer, options) {
        /* axelar.tss.exported.v1beta1.KeyRole key_role = 1; */
        if (message.keyRole !== 0)
            writer.tag(1, WireType.Varint).int32(message.keyRole);
        /* axelar.tss.exported.v1beta1.KeyType key_type = 2; */
        if (message.keyType !== 0)
            writer.tag(2, WireType.Varint).int32(message.keyType);
        /* axelar.utils.v1beta1.Threshold min_keygen_threshold = 3; */
        ...
        /* axelar.utils.v1beta1.Threshold safety_threshold = 4; */
        ...
        /* axelar.tss.exported.v1beta1.KeyShareDistributionPolicy key_share_distribution_policy = 5; */
        ...
        /* axelar.utils.v1beta1.Threshold keygen_voting_threshold = 8; */
        ...
        /* axelar.utils.v1beta1.Threshold sign_voting_threshold = 9; */
...
class SigKeyPair$Type extends MessageType {
    constructor() {
        super("axelar.tss.exported.v1beta1.SigKeyPair", [
