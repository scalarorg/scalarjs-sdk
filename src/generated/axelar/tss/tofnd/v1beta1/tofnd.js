...
// @generated from protobuf file "axelar/tss/tofnd/v1beta1/tofnd.proto" (package "axelar.tss.tofnd.v1beta1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf enum axelar.tss.tofnd.v1beta1.RecoverResponse.Response
 */
...
/**
 * @generated from protobuf enum axelar.tss.tofnd.v1beta1.MessageOut.CriminalList.Criminal.CrimeType
 */
...
class RecoverRequest$Type extends MessageType {
    constructor() {
        super("axelar.tss.tofnd.v1beta1.RecoverRequest", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* axelar.tss.tofnd.v1beta1.KeygenInit keygen_init */ 1:
                    message.keygenInit = KeygenInit.internalBinaryRead(reader, reader.uint32(), options, message.keygenInit);
                    break;
                case /* axelar.tss.tofnd.v1beta1.KeygenOutput keygen_output */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        /* axelar.tss.tofnd.v1beta1.KeygenInit keygen_init = 1; */
        ...
        /* axelar.tss.tofnd.v1beta1.KeygenOutput keygen_output = 2; */
...
/**
 * @generated MessageType for protobuf message axelar.tss.tofnd.v1beta1.RecoverRequest
 */
export const RecoverRequest = new RecoverRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RecoverResponse$Type extends MessageType {
    constructor() {
        super("axelar.tss.tofnd.v1beta1.RecoverResponse", [
            { no: 1, name: "response", kind: "enum", T: () => ["axelar.tss.tofnd.v1beta1.RecoverResponse.Response", RecoverResponse_Response, "RESPONSE_"] }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* axelar.tss.tofnd.v1beta1.RecoverResponse.Response response */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        /* axelar.tss.tofnd.v1beta1.RecoverResponse.Response response = 1; */
...
/**
 * @generated MessageType for protobuf message axelar.tss.tofnd.v1beta1.RecoverResponse
 */
export const RecoverResponse = new RecoverResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class KeygenOutput$Type extends MessageType {
    constructor() {
        super("axelar.tss.tofnd.v1beta1.KeygenOutput", [
...
/**
 * @generated MessageType for protobuf message axelar.tss.tofnd.v1beta1.KeygenOutput
 */
export const KeygenOutput = new KeygenOutput$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MessageIn$Type extends MessageType {
    constructor() {
        super("axelar.tss.tofnd.v1beta1.MessageIn", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* axelar.tss.tofnd.v1beta1.KeygenInit keygen_init */ 1:
                    ...
                    break;
                case /* axelar.tss.tofnd.v1beta1.SignInit sign_init */ 2:
                    message.data = {
                        oneofKind: "signInit",
                        signInit: SignInit.internalBinaryRead(reader, reader.uint32(), options, message.data.signInit)
                    };
                    break;
                case /* axelar.tss.tofnd.v1beta1.TrafficIn traffic */ 3:
                    message.data = {
                        oneofKind: "traffic",
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* axelar.tss.tofnd.v1beta1.SignInit sign_init = 2; */
        ...
        /* axelar.tss.tofnd.v1beta1.TrafficIn traffic = 3; */
...
/**
 * @generated MessageType for protobuf message axelar.tss.tofnd.v1beta1.MessageIn
 */
export const MessageIn = new MessageIn$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MessageOut$Type extends MessageType {
    constructor() {
        super("axelar.tss.tofnd.v1beta1.MessageOut", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* axelar.tss.tofnd.v1beta1.TrafficOut traffic */ 1:
                    message.data = {
                        oneofKind: "traffic",
                        traffic: TrafficOut.internalBinaryRead(reader, reader.uint32(), options, message.data.traffic)
                    };
                    break;
                case /* axelar.tss.tofnd.v1beta1.MessageOut.KeygenResult keygen_result */ 2:
                    message.data = {
                    ...
                    break;
                case /* axelar.tss.tofnd.v1beta1.MessageOut.SignResult sign_result */ 3:
                    message.data = {
    ...
    internalBinaryWrite(message, writer, options) {
        /* axelar.tss.tofnd.v1beta1.TrafficOut traffic = 1; */
        if (message.data.oneofKind === "traffic")
            TrafficOut.internalBinaryWrite(message.data.traffic, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* axelar.tss.tofnd.v1beta1.MessageOut.KeygenResult keygen_result = 2; */
        ...
        /* axelar.tss.tofnd.v1beta1.MessageOut.SignResult sign_result = 3; */
...
/**
 * @generated MessageType for protobuf message axelar.tss.tofnd.v1beta1.MessageOut
 */
export const MessageOut = new MessageOut$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MessageOut_KeygenResult$Type extends MessageType {
    constructor() {
        super("axelar.tss.tofnd.v1beta1.MessageOut.KeygenResult", [
    ...
    internalBinaryWrite(message, writer, options) {
        /* axelar.tss.tofnd.v1beta1.KeygenOutput data = 1; */
        ...
        /* axelar.tss.tofnd.v1beta1.MessageOut.CriminalList criminals = 2; */
...
/**
 * @generated MessageType for protobuf message axelar.tss.tofnd.v1beta1.MessageOut.KeygenResult
 */
...
class MessageOut_SignResult$Type extends MessageType {
    constructor() {
        super("axelar.tss.tofnd.v1beta1.MessageOut.SignResult", [
...
/**
 * @generated MessageType for protobuf message axelar.tss.tofnd.v1beta1.MessageOut.SignResult
 */
export const MessageOut_SignResult = new MessageOut_SignResult$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MessageOut_CriminalList$Type extends MessageType {
    constructor() {
        super("axelar.tss.tofnd.v1beta1.MessageOut.CriminalList", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated axelar.tss.tofnd.v1beta1.MessageOut.CriminalList.Criminal criminals */ 1:
    ...
    internalBinaryWrite(message, writer, options) {
        /* repeated axelar.tss.tofnd.v1beta1.MessageOut.CriminalList.Criminal criminals = 1; */
...
/**
 * @generated MessageType for protobuf message axelar.tss.tofnd.v1beta1.MessageOut.CriminalList
 */
...
class MessageOut_CriminalList_Criminal$Type extends MessageType {
    constructor() {
        super("axelar.tss.tofnd.v1beta1.MessageOut.CriminalList.Criminal", [
            { no: 1, name: "party_uid", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "crime_type", kind: "enum", T: () => ["axelar.tss.tofnd.v1beta1.MessageOut.CriminalList.Criminal.CrimeType", MessageOut_CriminalList_Criminal_CrimeType, "CRIME_TYPE_"] }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string party_uid */ 1:
                    ...
                    break;
                case /* axelar.tss.tofnd.v1beta1.MessageOut.CriminalList.Criminal.CrimeType crime_type */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* axelar.tss.tofnd.v1beta1.MessageOut.CriminalList.Criminal.CrimeType crime_type = 2; */
...
/**
 * @generated MessageType for protobuf message axelar.tss.tofnd.v1beta1.MessageOut.CriminalList.Criminal
 */
...
class TrafficIn$Type extends MessageType {
    constructor() {
        super("axelar.tss.tofnd.v1beta1.TrafficIn", [
...
/**
 * @generated MessageType for protobuf message axelar.tss.tofnd.v1beta1.TrafficIn
 */
export const TrafficIn = new TrafficIn$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TrafficOut$Type extends MessageType {
    constructor() {
        super("axelar.tss.tofnd.v1beta1.TrafficOut", [
...
/**
 * @generated MessageType for protobuf message axelar.tss.tofnd.v1beta1.TrafficOut
 */
export const TrafficOut = new TrafficOut$Type();
// @generated message type with reflection information, may provide speed optimized methods
class KeygenInit$Type extends MessageType {
    constructor() {
        super("axelar.tss.tofnd.v1beta1.KeygenInit", [
...
/**
 * @generated MessageType for protobuf message axelar.tss.tofnd.v1beta1.KeygenInit
 */
export const KeygenInit = new KeygenInit$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SignInit$Type extends MessageType {
    constructor() {
        super("axelar.tss.tofnd.v1beta1.SignInit", [
...
/**
 * @generated MessageType for protobuf message axelar.tss.tofnd.v1beta1.SignInit
 */
