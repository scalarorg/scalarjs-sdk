...
class KeygenVoteData$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.KeygenVoteData", [
...
class KeyInfo$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.KeyInfo", [
            { no: 1, name: "key_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "KeyID", "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/tss/exported.KeyID" } },
            { no: 2, name: "key_role", kind: "enum", T: () => ["axelar.tss.exported.v1beta1.KeyRole", KeyRole, "KEY_ROLE_"] },
            { no: 3, name: "key_type", kind: "enum", T: () => ["axelar.tss.exported.v1beta1.KeyType", KeyType, "KEY_TYPE_"] }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string key_id */ 1:
                    ...
                    break;
                case /* axelar.tss.exported.v1beta1.KeyRole key_role */ 2:
                    message.keyRole = reader.int32();
                    break;
                case /* axelar.tss.exported.v1beta1.KeyType key_type */ 3:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* axelar.tss.exported.v1beta1.KeyRole key_role = 2; */
        if (message.keyRole !== 0)
            writer.tag(2, WireType.Varint).int32(message.keyRole);
        /* axelar.tss.exported.v1beta1.KeyType key_type = 3; */
...
class MultisigInfo$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.MultisigInfo", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 target_num */ 3:
                    ...
                    break;
                case /* repeated axelar.tss.v1beta1.MultisigInfo.Info infos */ 4:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* repeated axelar.tss.v1beta1.MultisigInfo.Info infos = 4; */
...
class MultisigInfo_Info$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.MultisigInfo.Info", [
...
class KeyRecoveryInfo$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.KeyRecoveryInfo", [
            { no: 1, name: "key_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "KeyID", "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/tss/exported.KeyID" } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.bytes();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field axelar.tss.v1beta1.KeyRecoveryInfo.private");
            }
        }
...
class ExternalKeys$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.ExternalKeys", [
...
class ValidatorStatus$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.ValidatorStatus", [
