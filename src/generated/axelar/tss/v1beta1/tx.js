...
class StartKeygenRequest$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.StartKeygenRequest", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string sender */ 1:
                    ...
                    break;
                case /* axelar.tss.v1beta1.KeyInfo key_info */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* axelar.tss.v1beta1.KeyInfo key_info = 2; */
        if (message.keyInfo)
...
class StartKeygenResponse$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.StartKeygenResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class RotateKeyRequest$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.RotateKeyRequest", [
            ...
            { no: 3, name: "key_role", kind: "enum", T: () => ["axelar.tss.exported.v1beta1.KeyRole", KeyRole, "KEY_ROLE_"] },
            { no: 4, name: "key_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "KeyID", "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/tss/exported.KeyID" } }
        ], { "axelar.permission.exported.v1beta1.permission_role": "ROLE_CHAIN_MANAGEMENT" });
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string chain */ 2:
                    ...
                    break;
                case /* axelar.tss.exported.v1beta1.KeyRole key_role */ 3:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* axelar.tss.exported.v1beta1.KeyRole key_role = 3; */
...
class RotateKeyResponse$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.RotateKeyResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class ProcessKeygenTrafficRequest$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.ProcessKeygenTrafficRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string session_id */ 2:
                    ...
                    break;
                case /* axelar.tss.tofnd.v1beta1.TrafficOut payload */ 3:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* axelar.tss.tofnd.v1beta1.TrafficOut payload = 3; */
        if (message.payload)
...
class ProcessKeygenTrafficResponse$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.ProcessKeygenTrafficResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class ProcessSignTrafficRequest$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.ProcessSignTrafficRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
            { no: 2, name: "session_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "SessionID" } },
            { no: 3, name: "payload", kind: "message", T: () => TrafficOut, options: { "gogoproto.nullable": false } }
        ], { "axelar.permission.exported.v1beta1.permission_role": "ROLE_UNRESTRICTED" });
...
class ProcessSignTrafficResponse$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.ProcessSignTrafficResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class VotePubKeyRequest$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.VotePubKeyRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bytes sender */ 1:
                    message.sender = reader.bytes();
                    break;
                case /* axelar.vote.exported.v1beta1.PollKey poll_key */ 2:
                    message.pollKey = PollKey.internalBinaryRead(reader, reader.uint32(), options, message.pollKey);
                    break;
                case /* axelar.tss.tofnd.v1beta1.MessageOut.KeygenResult result */ 3:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.sender.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.sender);
        /* axelar.vote.exported.v1beta1.PollKey poll_key = 2; */
        if (message.pollKey)
            PollKey.internalBinaryWrite(message.pollKey, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* axelar.tss.tofnd.v1beta1.MessageOut.KeygenResult result = 3; */
        if (message.result)
...
class VotePubKeyResponse$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.VotePubKeyResponse", [
...
class VoteSigRequest$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.VoteSigRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
            { no: 2, name: "poll_key", kind: "message", T: () => PollKey, options: { "gogoproto.nullable": false } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* axelar.vote.exported.v1beta1.PollKey poll_key */ 2:
                    message.pollKey = PollKey.internalBinaryRead(reader, reader.uint32(), options, message.pollKey);
                    break;
                case /* axelar.tss.tofnd.v1beta1.MessageOut.SignResult result */ 3:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.pollKey)
            PollKey.internalBinaryWrite(message.pollKey, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* axelar.tss.tofnd.v1beta1.MessageOut.SignResult result = 3; */
        if (message.result)
...
class VoteSigResponse$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.VoteSigResponse", [
            { no: 1, name: "log", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value) {
...
class HeartBeatRequest$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.HeartBeatRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
            { no: 2, name: "key_ids", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "KeyIDs", "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/tss/exported.KeyID" } }
        ], { "axelar.permission.exported.v1beta1.permission_role": "ROLE_UNRESTRICTED" });
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
...
class HeartBeatResponse$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.HeartBeatResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class RegisterExternalKeysRequest$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.RegisterExternalKeysRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
            { no: 2, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/nexus/exported.ChainName" } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string chain */ 2:
                    message.chain = reader.string();
                    break;
                case /* repeated axelar.tss.v1beta1.RegisterExternalKeysRequest.ExternalKey external_keys */ 3:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.chain !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.chain);
        /* repeated axelar.tss.v1beta1.RegisterExternalKeysRequest.ExternalKey external_keys = 3; */
...
class RegisterExternalKeysRequest_ExternalKey$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.RegisterExternalKeysRequest.ExternalKey", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "ID", "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/tss/exported.KeyID" } },
...
class RegisterExternalKeysResponse$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.RegisterExternalKeysResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class SubmitMultisigPubKeysRequest$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.SubmitMultisigPubKeysRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
            { no: 2, name: "key_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "KeyID", "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/tss/exported.KeyID" } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string key_id */ 2:
                    message.keyId = reader.string();
                    break;
                case /* repeated axelar.tss.exported.v1beta1.SigKeyPair sig_key_pairs */ 3:
...
class SubmitMultisigPubKeysResponse$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.SubmitMultisigPubKeysResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
class SubmitMultisigSignaturesRequest$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.SubmitMultisigSignaturesRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
...
class SubmitMultisigSignaturesResponse$Type extends MessageType {
    constructor() {
        super("axelar.tss.v1beta1.SubmitMultisigSignaturesResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
