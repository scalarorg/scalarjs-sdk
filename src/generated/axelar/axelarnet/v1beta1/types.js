...
class IBCTransfer$Type extends MessageType {
    constructor() {
        super("axelar.axelarnet.v1beta1.IBCTransfer", [
            ...
            { no: 7, name: "id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, options: { "gogoproto.customname": "ID", "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/nexus/exported.TransferID" } },
            { no: 8, name: "status", kind: "enum", T: () => ["axelar.axelarnet.v1beta1.IBCTransfer.Status", IBCTransfer_Status, "STATUS_"] }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 id */ 7:
                    ...
                    break;
                case /* axelar.axelarnet.v1beta1.IBCTransfer.Status status */ 8:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* axelar.axelarnet.v1beta1.IBCTransfer.Status status = 8; */
        if (message.status !== 0)
...
class CosmosChain$Type extends MessageType {
    constructor() {
        super("axelar.axelarnet.v1beta1.CosmosChain", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/nexus/exported.ChainName" } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string ibc_path */ 2:
                    ...
                    break;
                case /* repeated axelar.axelarnet.v1beta1.Asset assets = 3 [deprecated = true];*/ 3:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* repeated axelar.axelarnet.v1beta1.Asset assets = 3 [deprecated = true]; */
...
class Asset$Type extends MessageType {
    constructor() {
        super("axelar.axelarnet.v1beta1.Asset", [
...
class Fee$Type extends MessageType {
    constructor() {
        super("axelar.axelarnet.v1beta1.Fee", [
