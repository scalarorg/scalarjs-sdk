...
class Params$Type extends MessageType {
    constructor() {
        super("axelar.axelarnet.v1beta1.Params", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 end_blocker_limit */ 4:
                    ...
                    break;
                case /* repeated axelar.axelarnet.v1beta1.CallContractProposalMinDeposit call_contracts_proposal_min_deposits */ 5:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* repeated axelar.axelarnet.v1beta1.CallContractProposalMinDeposit call_contracts_proposal_min_deposits = 5; */
...
class CallContractProposalMinDeposit$Type extends MessageType {
    constructor() {
        super("axelar.axelarnet.v1beta1.CallContractProposalMinDeposit", [
