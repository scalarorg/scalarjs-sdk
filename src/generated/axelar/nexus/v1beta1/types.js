...
// @generated from protobuf file "axelar/nexus/v1beta1/types.proto" (package "axelar.nexus.v1beta1", syntax proto3)
// tslint:disable
...
class MaintainerState$Type extends MessageType {
    constructor() {
        super("axelar.nexus.v1beta1.MaintainerState", [
            ...
            { no: 4, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/nexus/exported.ChainName" } }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bytes address */ 1:
                    ...
                    break;
                case /* axelar.utils.v1beta1.Bitmap missing_votes */ 2:
                    message.missingVotes = Bitmap.internalBinaryRead(reader, reader.uint32(), options, message.missingVotes);
                    break;
                case /* axelar.utils.v1beta1.Bitmap incorrect_votes */ 3:
...
/**
 * @generated MessageType for protobuf message axelar.nexus.v1beta1.MaintainerState
 */
export const MaintainerState = new MaintainerState$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ChainState$Type extends MessageType {
    constructor() {
        super("axelar.nexus.v1beta1.ChainState", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bool activated */ 3:
                    ...
                    break;
                case /* repeated axelar.nexus.exported.v1beta1.Asset assets */ 5:
                    message.assets.push(Asset.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated axelar.nexus.v1beta1.MaintainerState maintainer_states = 6 [deprecated = true];*/ 6:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* repeated axelar.nexus.v1beta1.MaintainerState maintainer_states = 6 [deprecated = true]; */
...
/**
 * @generated MessageType for protobuf message axelar.nexus.v1beta1.ChainState
 */
export const ChainState = new ChainState$Type();
// @generated message type with reflection information, may provide speed optimized methods
class LinkedAddresses$Type extends MessageType {
    constructor() {
        super("axelar.nexus.v1beta1.LinkedAddresses", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* axelar.nexus.exported.v1beta1.CrossChainAddress deposit_address */ 1:
                    message.depositAddress = CrossChainAddress.internalBinaryRead(reader, reader.uint32(), options, message.depositAddress);
                    break;
                case /* axelar.nexus.exported.v1beta1.CrossChainAddress recipient_address */ 2:
...
/**
 * @generated MessageType for protobuf message axelar.nexus.v1beta1.LinkedAddresses
 */
export const LinkedAddresses = new LinkedAddresses$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RateLimit$Type extends MessageType {
    constructor() {
        super("axelar.nexus.v1beta1.RateLimit", [
...
/**
 * @generated MessageType for protobuf message axelar.nexus.v1beta1.RateLimit
 */
export const RateLimit = new RateLimit$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TransferEpoch$Type extends MessageType {
    constructor() {
        super("axelar.nexus.v1beta1.TransferEpoch", [
            { no: 1, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/nexus/exported.ChainName" } },
            { no: 2, name: "amount", kind: "message", T: () => Coin, options: { "gogoproto.nullable": false } },
            { no: 3, name: "epoch", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 4, name: "direction", kind: "enum", T: () => ["axelar.nexus.exported.v1beta1.TransferDirection", TransferDirection, "TRANSFER_DIRECTION_"] }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 epoch */ 3:
                    ...
                    break;
                case /* axelar.nexus.exported.v1beta1.TransferDirection direction */ 4:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* axelar.nexus.exported.v1beta1.TransferDirection direction = 4; */
...
/**
 * @generated MessageType for protobuf message axelar.nexus.v1beta1.TransferEpoch
 */
