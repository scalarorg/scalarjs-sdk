...
// @generated from protobuf file "axelar/nexus/exported/v1beta1/types.proto" (package "axelar.nexus.exported.v1beta1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf enum axelar.nexus.exported.v1beta1.GeneralMessage.Status
 */
...
/**
 * @generated from protobuf enum axelar.nexus.exported.v1beta1.TransferState
 */
...
/**
 * @generated from protobuf enum axelar.nexus.exported.v1beta1.TransferDirection
 */
...
class Chain$Type extends MessageType {
    constructor() {
        super("axelar.nexus.exported.v1beta1.Chain", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "ChainName" } },
            { no: 3, name: "supports_foreign_assets", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string name */ 1:
                    ...
                    break;
                case /* bool supports_foreign_assets */ 3:
                    message.supportsForeignAssets = reader.bool();
                    break;
                case /* axelar.tss.exported.v1beta1.KeyType key_type */ 4:
                    message.keyType = reader.int32();
                    break;
                case /* string module */ 5:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.supportsForeignAssets !== false)
            writer.tag(3, WireType.Varint).bool(message.supportsForeignAssets);
        /* axelar.tss.exported.v1beta1.KeyType key_type = 4; */
        if (message.keyType !== 0)
            writer.tag(4, WireType.Varint).int32(message.keyType);
        /* string module = 5; */
        if (message.module !== "")
            writer.tag(5, WireType.LengthDelimited).string(message.module);
...
/**
 * @generated MessageType for protobuf message axelar.nexus.exported.v1beta1.Chain
 */
export const Chain = new Chain$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CrossChainAddress$Type extends MessageType {
    constructor() {
        super("axelar.nexus.exported.v1beta1.CrossChainAddress", [
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* axelar.nexus.exported.v1beta1.Chain chain */ 1:
...
/**
 * @generated MessageType for protobuf message axelar.nexus.exported.v1beta1.CrossChainAddress
 */
export const CrossChainAddress = new CrossChainAddress$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CrossChainTransfer$Type extends MessageType {
    constructor() {
        super("axelar.nexus.exported.v1beta1.CrossChainTransfer", [
            ...
            { no: 4, name: "state", kind: "enum", T: () => ["axelar.nexus.exported.v1beta1.TransferState", TransferState, "TRANSFER_STATE_"] }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* axelar.nexus.exported.v1beta1.CrossChainAddress recipient */ 1:
                ...
                case /* uint64 id */ 3:
                    ...
                    break;
                case /* axelar.nexus.exported.v1beta1.TransferState state */ 4:
    ...
    internalBinaryWrite(message, writer, options) {
        /* axelar.nexus.exported.v1beta1.CrossChainAddress recipient = 1; */
        ...
        /* axelar.nexus.exported.v1beta1.TransferState state = 4; */
        if (message.state !== 0)
...
/**
 * @generated MessageType for protobuf message axelar.nexus.exported.v1beta1.CrossChainTransfer
 */
export const CrossChainTransfer = new CrossChainTransfer$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TransferFee$Type extends MessageType {
    constructor() {
        super("axelar.nexus.exported.v1beta1.TransferFee", [
...
/**
 * @generated MessageType for protobuf message axelar.nexus.exported.v1beta1.TransferFee
 */
export const TransferFee = new TransferFee$Type();
// @generated message type with reflection information, may provide speed optimized methods
class FeeInfo$Type extends MessageType {
    constructor() {
        super("axelar.nexus.exported.v1beta1.FeeInfo", [
...
/**
 * @generated MessageType for protobuf message axelar.nexus.exported.v1beta1.FeeInfo
 */
export const FeeInfo = new FeeInfo$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Asset$Type extends MessageType {
    constructor() {
        super("axelar.nexus.exported.v1beta1.Asset", [
...
/**
 * @generated MessageType for protobuf message axelar.nexus.exported.v1beta1.Asset
 */
export const Asset = new Asset$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GeneralMessage$Type extends MessageType {
    constructor() {
        super("axelar.nexus.exported.v1beta1.GeneralMessage", [
            ...
            { no: 5, name: "status", kind: "enum", T: () => ["axelar.nexus.exported.v1beta1.GeneralMessage.Status", GeneralMessage_Status, "STATUS_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string id */ 1:
                    ...
                    break;
                case /* axelar.nexus.exported.v1beta1.CrossChainAddress sender */ 2:
                    message.sender = CrossChainAddress.internalBinaryRead(reader, reader.uint32(), options, message.sender);
                    break;
                case /* axelar.nexus.exported.v1beta1.CrossChainAddress recipient */ 3:
                    message.recipient = CrossChainAddress.internalBinaryRead(reader, reader.uint32(), options, message.recipient);
                    break;
                case /* bytes payload_hash */ 4:
                    message.payloadHash = reader.bytes();
                    break;
                case /* axelar.nexus.exported.v1beta1.GeneralMessage.Status status */ 5:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* axelar.nexus.exported.v1beta1.CrossChainAddress sender = 2; */
        if (message.sender)
            CrossChainAddress.internalBinaryWrite(message.sender, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* axelar.nexus.exported.v1beta1.CrossChainAddress recipient = 3; */
        if (message.recipient)
        ...
        /* axelar.nexus.exported.v1beta1.GeneralMessage.Status status = 5; */
        if (message.status !== 0)
...
/**
 * @generated MessageType for protobuf message axelar.nexus.exported.v1beta1.GeneralMessage
 */
export const GeneralMessage = new GeneralMessage$Type();
// @generated message type with reflection information, may provide speed optimized methods
class WasmMessage$Type extends MessageType {
    constructor() {
        super("axelar.nexus.exported.v1beta1.WasmMessage", [
...
/**
 * @generated MessageType for protobuf message axelar.nexus.exported.v1beta1.WasmMessage
 */
