...
class KeygenStarted$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.KeygenStarted", [
...
class KeygenCompleted$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.KeygenCompleted", [
            { no: 1, name: "module", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "key_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "KeyID", "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/multisig/exported.KeyID" } }
...
class KeygenExpired$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.KeygenExpired", [
            { no: 1, name: "module", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "key_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "KeyID", "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/multisig/exported.KeyID" } }
        ], { "gogoproto.messagename": true });
    }
...
class PubKeySubmitted$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.PubKeySubmitted", [
            { no: 1, name: "module", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "key_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "KeyID", "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/multisig/exported.KeyID" } },
            ...
            { no: 4, name: "pub_key", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/multisig/exported.PublicKey" } }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
...
class SigningStarted$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.SigningStarted", [
            { no: 1, name: "module", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            ...
            { no: 4, name: "pub_keys", kind: "map", K: 9 /*ScalarType.STRING*/, V: { kind: "scalar", T: 12 /*ScalarType.BYTES*/ }, options: { "gogoproto.castvalue": "github.com/axelarnetwork/axelar-core/x/multisig/exported.PublicKey" } },
            { no: 5, name: "payload_hash", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/multisig/exported.Hash" } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.bytes();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field axelar.multisig.v1beta1.SigningStarted.pub_keys");
            }
        }
...
class SigningCompleted$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.SigningCompleted", [
            { no: 1, name: "module", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "sig_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, options: { "gogoproto.customname": "SigID" } }
        ]);
    }
...
class SigningExpired$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.SigningExpired", [
            { no: 1, name: "module", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "sig_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, options: { "gogoproto.customname": "SigID" } }
        ]);
    }
...
class SignatureSubmitted$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.SignatureSubmitted", [
            { no: 1, name: "module", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "sig_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, options: { "gogoproto.customname": "SigID" } },
            { no: 3, name: "participant", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.ValAddress" } },
...
class KeyAssigned$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.KeyAssigned", [
            { no: 1, name: "module", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class KeyRotated$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.KeyRotated", [
            { no: 1, name: "module", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "chain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/nexus/exported.ChainName" } },
            { no: 3, name: "key_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "KeyID", "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/multisig/exported.KeyID" } }
        ]);
...
class KeygenOptOut$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.KeygenOptOut", [
...
class KeygenOptIn$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.KeygenOptIn", [
            { no: 1, name: "participant", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } }
        ]);
    }
    create(value) {
