...
// @generated from protobuf file "axelar/multisig/v1beta1/tx.proto" (package "axelar.multisig.v1beta1", syntax proto3)
// tslint:disable
...
class StartKeygenRequest$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.StartKeygenRequest", [
            ...
            { no: 2, name: "key_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "KeyID", "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/multisig/exported.KeyID" } }
...
/**
 * @generated MessageType for protobuf message axelar.multisig.v1beta1.StartKeygenRequest
 */
export const StartKeygenRequest = new StartKeygenRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class StartKeygenResponse$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.StartKeygenResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
/**
 * @generated MessageType for protobuf message axelar.multisig.v1beta1.StartKeygenResponse
 */
export const StartKeygenResponse = new StartKeygenResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SubmitPubKeyRequest$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.SubmitPubKeyRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
            { no: 2, name: "key_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "KeyID", "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/multisig/exported.KeyID" } },
            { no: 3, name: "pub_key", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/multisig/exported.PublicKey" } },
...
/**
 * @generated MessageType for protobuf message axelar.multisig.v1beta1.SubmitPubKeyRequest
 */
export const SubmitPubKeyRequest = new SubmitPubKeyRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SubmitPubKeyResponse$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.SubmitPubKeyResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
/**
 * @generated MessageType for protobuf message axelar.multisig.v1beta1.SubmitPubKeyResponse
 */
export const SubmitPubKeyResponse = new SubmitPubKeyResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SubmitSignatureRequest$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.SubmitSignatureRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } },
...
/**
 * @generated MessageType for protobuf message axelar.multisig.v1beta1.SubmitSignatureRequest
 */
...
class SubmitSignatureResponse$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.SubmitSignatureResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
/**
 * @generated MessageType for protobuf message axelar.multisig.v1beta1.SubmitSignatureResponse
 */
export const SubmitSignatureResponse = new SubmitSignatureResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RotateKeyRequest$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.RotateKeyRequest", [
...
/**
 * @generated MessageType for protobuf message axelar.multisig.v1beta1.RotateKeyRequest
 */
export const RotateKeyRequest = new RotateKeyRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RotateKeyResponse$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.RotateKeyResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
/**
 * @generated MessageType for protobuf message axelar.multisig.v1beta1.RotateKeyResponse
 */
export const RotateKeyResponse = new RotateKeyResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class KeygenOptOutRequest$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.KeygenOptOutRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } }
        ], { "axelar.permission.exported.v1beta1.permission_role": "ROLE_UNRESTRICTED" });
    }
    create(value) {
...
/**
 * @generated MessageType for protobuf message axelar.multisig.v1beta1.KeygenOptOutRequest
 */
export const KeygenOptOutRequest = new KeygenOptOutRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class KeygenOptOutResponse$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.KeygenOptOutResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
/**
 * @generated MessageType for protobuf message axelar.multisig.v1beta1.KeygenOptOutResponse
 */
export const KeygenOptOutResponse = new KeygenOptOutResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class KeygenOptInRequest$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.KeygenOptInRequest", [
            { no: 1, name: "sender", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/cosmos/cosmos-sdk/types.AccAddress" } }
        ], { "axelar.permission.exported.v1beta1.permission_role": "ROLE_UNRESTRICTED" });
    }
    create(value) {
...
/**
 * @generated MessageType for protobuf message axelar.multisig.v1beta1.KeygenOptInRequest
 */
export const KeygenOptInRequest = new KeygenOptInRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class KeygenOptInResponse$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.KeygenOptInResponse", []);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        if (value !== undefined)
...
/**
 * @generated MessageType for protobuf message axelar.multisig.v1beta1.KeygenOptInResponse
 */
