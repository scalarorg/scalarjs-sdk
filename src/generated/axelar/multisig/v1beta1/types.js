...
class Key$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.Key", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "ID", "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/multisig/exported.KeyID" } },
            { no: 2, name: "snapshot", kind: "message", T: () => Snapshot, options: { "gogoproto.nullable": false } },
            { no: 3, name: "pub_keys", kind: "map", K: 9 /*ScalarType.STRING*/, V: { kind: "scalar", T: 12 /*ScalarType.BYTES*/ }, options: { "gogoproto.castvalue": "github.com/axelarnetwork/axelar-core/x/multisig/exported.PublicKey" } },
            { no: 4, name: "signing_threshold", kind: "message", T: () => Threshold, options: { "gogoproto.nullable": false } },
            { no: 5, name: "state", kind: "enum", T: () => ["axelar.multisig.exported.v1beta1.KeyState", KeyState, "KEY_STATE_"] }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string id */ 1:
                    ...
                    break;
                case /* axelar.snapshot.exported.v1beta1.Snapshot snapshot */ 2:
                ...
                case /* map<string, bytes> pub_keys */ 3:
                    ...
                    break;
                case /* axelar.utils.v1beta1.Threshold signing_threshold */ 4:
                    message.signingThreshold = Threshold.internalBinaryRead(reader, reader.uint32(), options, message.signingThreshold);
                    break;
                case /* axelar.multisig.exported.v1beta1.KeyState state */ 5:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.bytes();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field axelar.multisig.v1beta1.Key.pub_keys");
            }
        }
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* axelar.snapshot.exported.v1beta1.Snapshot snapshot = 2; */
        if (message.snapshot)
        ...
        /* axelar.utils.v1beta1.Threshold signing_threshold = 4; */
        ...
        /* axelar.multisig.exported.v1beta1.KeyState state = 5; */
        if (message.state !== 0)
...
class KeygenSession$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.KeygenSession", [
            { no: 1, name: "key", kind: "message", T: () => Key, options: { "gogoproto.nullable": false } },
            { no: 2, name: "state", kind: "enum", T: () => ["axelar.multisig.exported.v1beta1.MultisigState", MultisigState, "MULTISIG_STATE_"] },
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* axelar.multisig.v1beta1.Key key */ 1:
                    message.key = Key.internalBinaryRead(reader, reader.uint32(), options, message.key);
                    break;
                case /* axelar.multisig.exported.v1beta1.MultisigState state */ 2:
                    message.state = reader.int32();
                    break;
                case /* axelar.utils.v1beta1.Threshold keygen_threshold */ 3:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.bool();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field axelar.multisig.v1beta1.KeygenSession.is_pub_key_received");
            }
        }
        map[key !== null && key !== void 0 ? key : ""] = val !== null && val !== void 0 ? val : false;
    }
    internalBinaryWrite(message, writer, options) {
        /* axelar.multisig.v1beta1.Key key = 1; */
        if (message.key)
            Key.internalBinaryWrite(message.key, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* axelar.multisig.exported.v1beta1.MultisigState state = 2; */
        if (message.state !== 0)
            writer.tag(2, WireType.Varint).int32(message.state);
        /* axelar.utils.v1beta1.Threshold keygen_threshold = 3; */
...
class MultiSig$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.MultiSig", [
            ...
            { no: 2, name: "payload_hash", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.casttype": "github.com/axelarnetwork/axelar-core/x/multisig/exported.Hash" } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.bytes();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field axelar.multisig.v1beta1.MultiSig.sigs");
            }
        }
        map[key !== null && key !== void 0 ? key : ""] = val !== null && val !== void 0 ? val : new Uint8Array(0);
    }
...
class SigningSession$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.SigningSession", [
            ...
            { no: 3, name: "state", kind: "enum", T: () => ["axelar.multisig.exported.v1beta1.MultisigState", MultisigState, "MULTISIG_STATE_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint64 id */ 1:
                    ...
                    break;
                case /* axelar.multisig.v1beta1.MultiSig multi_sig */ 2:
                    message.multiSig = MultiSig.internalBinaryRead(reader, reader.uint32(), options, message.multiSig);
                    break;
                case /* axelar.multisig.exported.v1beta1.MultisigState state */ 3:
                    message.state = reader.int32();
                    break;
                case /* axelar.multisig.v1beta1.Key key */ 4:
                    message.key = Key.internalBinaryRead(reader, reader.uint32(), options, message.key);
                    break;
...
class KeyEpoch$Type extends MessageType {
    constructor() {
        super("axelar.multisig.v1beta1.KeyEpoch", [
